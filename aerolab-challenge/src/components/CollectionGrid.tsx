...
export function CollectionGrid({ className }: CollectionGridProps) {
  const { getSortedCollection, removeGame, isLoading, isClient } =
    useGameCollection();
  const [sortBy, setSortBy] = useState<"dateAdded" | "releaseDate">(
    "dateAdded"
  );
    ...
    return (
      <div className={cn("text-center py-12", className)}>
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-6">
          Start building your collection by searching for games and adding them
          to your library.
        </p>
          ...
          <div className="flex items-center bg-gray-100 dark:bg-dark-700 rounded-lg p-1">
            <button
              ...
              className={cn(
                ...
                sortBy === "dateAdded"
                  ? "bg-white dark:bg-dark-600 text-black shadow-sm"
          ...
          <button
            ...
            className={cn(
              ...
              showRemoveButtons
                ...
                : "bg-gray-100 dark:bg-dark-700 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100"
            )}
            title={
              showRemoveButtons ? "Hide remove buttons" : "Show remove buttons"
            }
          >
